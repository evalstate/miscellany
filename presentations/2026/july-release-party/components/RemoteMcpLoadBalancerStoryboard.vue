...
.remote-mcp-story__node--lb .remote-mcp-story__role,
.remote-mcp-story__node--server-b .remote-mcp-story__role {
  fill: #d1d5db;
}

.remote-mcp-story__node--lb .remote-mcp-story__title,
.remote-mcp-story__node--server-b .remote-mcp-story__title {
  fill: #ffffff;
}

.remote-mcp-story__node--lb .remote-mcp-story__detail,
.remote-mcp-story__node--server-b .remote-mcp-story__detail {
  fill: #e5e7eb;
}
