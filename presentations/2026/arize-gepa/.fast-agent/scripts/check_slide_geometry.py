...
Examples:
  ...
  python3 .fast-agent/scripts/check_slide_geometry.py --range 13-15
  python3 .fast-agent/scripts/check_slide_geometry.py --range 13-15 --fail-on findings
"""
...
try:
    ...
    raise SystemExit(
        ".fast-agent/scripts/check_slide_geometry.py requires the Python package 'websockets'. "
